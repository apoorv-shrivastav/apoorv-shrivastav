...
- [`Pramatix`](https://github.com/apoorv-shrivastav/agentic-experimentation-platform) — an agentic experimentation platform for AI features. Multi-agent pipeline (Designer · Analyst · Critic · Communicator), real statistical depth, enterprise governance
